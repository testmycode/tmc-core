...
public class AdaptiveExerciseParserTest {
    ...
    @Test
    public void exerciseAvailable() {
        Exercise exercise = adaptiveParser.parseFromJson("{ available: true, zip_url: someUrl }");
        assertEquals(URI.create("http://ohtu-skillifier.herokuapp.comsomeUrl"), exercise.getZipUrl());
    }
}
