...
public class CourseSubmitterTest {
    ...
    public void setup() throws IOException, TmcCoreException {
        ...
        mockUrlCommunicator("/courses.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.allCoursesExample);
        mockUrlCommunicator("courses/3.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.courseExample);
        mockUrlCommunicator("courses/19.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.noDeadlineCourseExample);
        mockUrlCommunicator("courses/21.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.expiredCourseExample);
        mockUrlCommunicatorWithFile("https://tmc.mooc.fi/staging/exercises/285/submissions.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.submitResponse);
        mockUrlCommunicatorWithFile("https://tmc.mooc.fi/staging/exercises/287/submissions.json?api_version=7&client=tmc_cli&client_version=1", ExampleJson.pasteResponse);
    ...
    public void testSubmitWithOneParam() throws IOException, ParseException, ExpiredException, IllegalArgumentException, ZipException, TmcCoreException {
        ...
        String submissionPath = "http://127.0.0.1:8080/submissions/1781.json?api_version=7&client=tmc_cli&client_version=1";
